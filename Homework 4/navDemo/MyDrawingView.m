...
- (void)drawRect:(CGRect)rect
{
    ...
    //drawing the other lines of the pentagon
    CGContextAddLineToPoint(context, 180, 120);
    CGContextAddLineToPoint(context, 180, 140);
    CGContextAddLineToPoint(context, 120, 140);
    CGContextAddLineToPoint(context, 120, 120);
    //closing the path of the pentagon
    CGContextClosePath(context);
    
    //setting the line width
    CGContextSetLineWidth(context, 2.0);
    //seting the color of the line
...
-(CGMutablePathRef)makeAPath
{
  ...
  CGPoint s[arraySize] = {20, 320, 30, 300, 40, 290, 50, 300, 60, 310, 70, 340,
    80, 350, 90, 360, 100, 370, 110, 380, 120, 390, 130, 320};
...
-(void)drawPathAnimated
{
  ...
  pathAnimation2.toValue = [UIColor redColor].CGColor;
